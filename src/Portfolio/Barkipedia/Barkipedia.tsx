            ...
            <div className="portfolioRoot" id="barkipedia">
                ...
                <div className="subRoot" id="barkipedia">
                    ...
                    <div className="descriptionContent">
                        ...
                        and was an informational dog application for current and prospective dog owners. The app would allow users to optimize
                    ...
                    <div className="stepsContent">
                            ...
                            2. Brainstorm as a team, sketch ideas, refine best ideas, create a wireframe/lofi prototype <br/>
                            3. Create a hifi prototype on Adobe XD, identify weak points of the prototype, finalize hifi prototype <br/>
                    </div>
                    ...
                    <div className="extras" id="barkipedia">
                        <div>
                            group portfolio
                            <div>
                                <Button style={{maxHeight: "30px", maxWidth: "30px", minHeight: "30px", minWidth: "30px"}} href="https://cpsc481fall2019.github.io/index.html">
                        ...
                        <div>
                            ...
                            <div>
                                <Button style={{maxHeight: "30px", maxWidth: "30px", minHeight: "30px", minWidth: "30px"}} href="https://xd.adobe.com/view/f1f8bda3-f374-49f9-776b-e1133915443b-87c9/?fullscreen">
